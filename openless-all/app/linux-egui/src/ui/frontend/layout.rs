...
pub fn sidebar(ctx: &egui::Context, vm: &mut FrontendViewModel, actions: &mut Vec<FrontendAction>) {
    ...
    egui::Area::new(egui::Id::new("openless-sidebar"))
        ...
        .show(ctx, |ui| {
            ...
            ui.painter()
                .rect_filled(ui.max_rect(), 0.0, theme::sidebar_bg());
            ui.painter().line_segment(
                [
            ...
            egui::Frame::NONE
                ...
                .show(ui, |ui| {
                    ...
                    if vm.tools_open {
                        ...
                        subnav(ui, vm, "纠错", Page::Corrections, actions);
                    }
    ...
    egui::Frame::new()
        ...
        .show(ui, |ui| {
            ui.vertical_centered(|ui| {
                ui.label(
                    egui::RichText::new(theme::text("此页面暂未接线"))
                        .size(13.0)
                        .color(theme::ink_3()),
                );
                ui.add_space(4.0);
                ui.label(
                    egui::RichText::new(theme::text("数据桥接将在后续阶段完成"))
                        .size(11.0)
                        .color(theme::ink_4()),
                );
            });

...
pub fn marketplace_page(
    ...
    ui.horizontal(|ui| {
        ui.label(
            egui::RichText::new(theme::text("探索社区风格包"))
                .size(13.0)
                .color(theme::ink_3()),
        );
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            let refresh = ui.add(
                egui::Button::new(egui::RichText::new(theme::text("↻  刷新")).size(11.5))
                    .fill(theme::surface())
            ...
            ui.add_space(8.0);
            let mine = ui.add(
                egui::Button::new(egui::RichText::new(theme::text("我的发布")).size(11.5))
                    .fill(theme::surface())
                    .stroke(egui::Stroke::new(0.8, theme::line()))
                    .corner_radius(egui::CornerRadius::same(8))
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ui.vertical_centered(|ui| {
                    ui.label(
                        egui::RichText::new(theme::text("风格市场暂未接线"))
                            .size(13.0)
                            .color(theme::ink_3()),
                    );
                    ui.add_space(4.0);
                    ui.label(
                        egui::RichText::new(theme::text("市场后端桥接将在后续阶段完成"))
                            .size(11.0)
                            .color(theme::ink_4()),
                    );
                });
    ...
    if vm.marketplace_packs.is_empty() {
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ui.vertical_centered(|ui| {
                    ui.label(
                        egui::RichText::new(theme::text("暂时没有找到风格包"))
                            .size(13.0)
                            .color(theme::ink_3()),
                    );
                    ui.add_space(4.0);
                    ui.label(
                        egui::RichText::new(theme::text("试试其他关键词或筛选条件"))
                            .size(11.0)
                            .color(theme::ink_4()),
                    );
                });
    ...
    if let Some(index) = vm.marketplace_selected {
        if let Some(pack) = vm.marketplace_packs.get(index) {
            marketplace_detail(
                ...
                vm.marketplace_prompt.as_deref(),
                body_rect,
                actions,
            );
        }
...
fn marketplace_card(
    ...
    ui.with_layout(egui::Layout::bottom_up(egui::Align::Min), |ui| {
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                let download = ui.add(
                    egui::Button::new(egui::RichText::new(theme::text("下载 ZIP")).size(10.0))
            ...
            egui::Frame::new()
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        egui::ScrollArea::vertical().max_height(150.0).id_salt("marketplace-prompt").show(ui,|ui|{ui.label(prompt);});
                    }else{ui.spinner();}

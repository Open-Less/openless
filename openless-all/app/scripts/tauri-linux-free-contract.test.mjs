...
//   - `#[cfg(any(target_os = "macos", target_os = "linux"))]`-style platform
//     exclusions are allowed: they are shared macOS code, not Linux support.
...
// ── 1. Rust: no Linux-only cfg blocks beyond the compile_error! guard ────────

...
export const ja: typeof zhCN = {
  ...
  history: {
    ...
    cancelledRecording: '録音をキャンセル · 音声は保存済み',
    cancelledRecordingHint: 'この録音はまだ文字起こしされていません。録音を続けるか、現在の音声モデルですぐに文字起こしできます。',
    continueRecording: '録音を続ける',
    continuingRecording: '再開中…',
    continueRecordingFailed: '録音を再開できません：{{err}}',
    startTranscription: '文字起こしを開始',
    pendingTranscription: '文字起こし待ち',
    transcribedOnly: '文字起こし済み',
    rawLabel: '原文',
    rawEmpty: '（空）',
    selectHint: '左側から 1 件選択して詳細を表示。',
    recorded: '録音 {{duration}}',
    stepAsr: '認識',
    stepAsrDictionary: 'ASR 辞書',
    dictionaryDeliveryCounts: '{{sent}} 件送信 / {{dropped}} 件省略',
    multimodalPipeline: 'マルチモーダル',
    stepAsrHint: 'キーを離してから認識結果を待った時間。ストリーミング認識は録音中に変換するため、通常は録音時間よりずっと短くなります。',
    stepPolish: '推敲',
    stepLlmDictionary: 'LLM 辞書',
    dictionaryPrompt: '推敲プロンプトに追加済み',
    stepInsert: '挿入',
    chars: '{{count}} 文字',
  ...
  vocab: {
    ...
    deliveryMode: 'ASR 配信：{{mode}}',
    deliveryCounts: '{{sent}} 件送信 · {{dropped}} 件省略',
    inboxTitle: '保留中の候補（{{count}}）',
    scopeTitle: '単語の範囲',
    scopeGlobal: '全体 · 永続',
    scopeProjectTemporary: '現在のアプリ · 一時',
    searchPlaceholder: '単語またはメモを検索…',
    sourceFilter: '出所で絞り込む',
    sourceAll: 'すべての出所',
    sourceManual: '手動',
    sourceLearned: '学習',
    sourceImported: 'インポート',
    scopeFilter: '範囲で絞り込む',
    scopeAll: 'すべての範囲',
    scopePersistent: '永続',
    scopeTemporaryBadge: '一時',
    pin: '固定して ASR 優先度を上げる',
    unpin: '固定を解除',
    upgradeGlobal: '全体の永続単語として保存',
    keep: '永続化',
    corrections: {
      title: '補正ルール',
  ...
  settings: {
    ...
    dataStorage: {
      ...
      cursorContextDesc:
        '推敲時にカーソル周辺の短いテキストを読み取ります。オンでは設定中の LLM へ送信し、オフでは読み取りません。macOS は Accessibility、Windows は TSF、Linux は fcitx SurroundingText を使用し、パスワードや機密入力は常に遮断します。',
      cursorContextLlmLabel: '文書コンテキストを LLM 推敲に使用',
      cursorContextLlmDesc: 'カーソル周辺の短い範囲を設定済み LLM のリクエストに含めます。',
      editLearningLabel: '手動修正から単語を提案',
      editLearningDesc: 'OpenLess が今回挿入した範囲だけを監視し、保存前に必ず確認します。',
      vocabInboxLabel: '単語候補の受信箱を保持',
      vocabInboxDesc: '未処理の候補を端末内に 7 日間保持し、無効にすると消去します。',
      temporaryVocabTtlLabel: 'アプリ別一時単語の有効日数',
      temporaryVocabCapacityLabel: '一時単語の上限',
      temporaryVocabCapacityDesc: '最近使われていない一時単語から削除し、固定・永続単語は削除しません。',
    },
    codingConsole: {
      title: 'Claude コンソール',

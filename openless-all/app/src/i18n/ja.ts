...
export const ja: typeof zhCN = {
  ...
  cloudSyncE2ee: {
    ...
    enable: '暗号化同期を有効にする',
    setPassword: '同期パスワードを設定',
    stepEnableTitle: '手順 1/3：同期をオンにする',
    stepEnableDetail: 'スイッチを使います。確認のあと、次は同期パスワードの設定です。',
    stepPasswordTitle: '手順 2/3：同期パスワードを設定',
    stepPasswordDetail: 'あと 1 ステップです。パスワードを設定するまで同期は始まりません。',
    stepUnlockTitle: '手順 2/3：このデバイスのロックを解除',
    stepUnlockDetail:
      'あと 1 ステップです。同期パスワードを入力して、このデバイスのロックを解除します。',
    stepClosedTitle: '同期はオフです',
    stepClosedDetail:
      'クラウドのバックアップは残っています。続けるには上のスイッチをオンにしてください。',
    stepDoneTitle: '手順 3/3：同期の準備ができました',
    stepDoneDetail: 'このデバイスはロック解除済みで、同期はオンです。',
    stepPreparingTitle: '次の手順を開いています',
    stepPreparingDetail: '確認は済みました。次に同期パスワードを設定します。まだ完了していません。',
    stepFollowDetail: 'この行のボタンで続けてください。',
    refresh: '状態を更新',
    loading: '同期状態を確認中…',
    signIn: 'GitHub でログイン',
    signOut: 'ログアウト',
    ...
    errors: {
      ...
      localData:
        'このデバイスのデータを準備できませんでした。「状態を更新」を押して、もう一度試してください。',
    },
  },
  cloudSync: {
    title: 'クラウド同期',
  ...
  lessComputer: {
    ...
    desktop: {
      ...
      apiCost: '今回の API 料金',
      emptyHint: 'タスクを入力するか、マイクをタップするか、音声ショートカットで始めましょう。',
      showInspector: 'ワークスペースを表示',
      hideInspector: 'ワークスペースを隠す',
      inspectorTitle: 'ワークスペース',
      inspectorStatus: 'ステータス',
      inspectorTurn: 'このターン',
      toolCalls: 'ツール呼び出し',
      pendingApprovals: '確認待ち',
      inspectorVoice: '音声入力',
      voiceShortcutOff: '音声ショートカットが未設定です。設定で有効にできます。',
      voiceModesHint:
        'マイク：話した内容が入力欄に入り、編集してから送信できます。音声ボタン：話し終えるとそのままエージェントに送信します。',
      copy: 'コピー',
      copied: 'コピーしました',
      messagePlaceholder: '{{agent}} にメッセージ',
    },
    voice: {
      dictate: '入力欄に音声入力',
      voiceMode: '音声モード（停止で送信）',
      stopTask: 'タスクを停止',
      cancel: '録音をキャンセル',
      confirmDictation: '音声入力を完了',
      stopAndSend: '停止して送信',
      listening: '聞き取り中…',
      starting: 'マイクを準備中…',
      transcribing: '文字起こし中…',
      empty: '聞き取れませんでした。もう一度お話しください。',
      failed: '音声認識に失敗しました。もう一度お試しください。',
      startFailed: '録音を開始できません：{{message}}',
      taskCancelFailed: 'タスクを停止できませんでした。もう一度お試しください。',
      dictateCaption:
        '話し終えたら ✓ をタップ。テキストは入力欄に入り編集できます · Esc でキャンセル',
      submitCaption: '↑ をタップするとそのままエージェントに送信 · Esc でキャンセル',
      stopHint: 'タスク実行中：■ で停止できます',
      holdHint: '{{key}} を押している間話す',
      toggleHint: '{{key}} を押して開始・終了',
      autoHint: '{{key}} を長押しまたはタップして話す',
    },
    title: 'Less Computer',

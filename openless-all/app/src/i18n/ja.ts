...
export const ja: typeof zhCN = {
  ...
  overview: {
    ...
    metricTotalExceeded: 'ローカル保存の上限を超えました',
    metricTotalArchived: 'ローカルに{{count}}件保存済み',
    weekTitle: '直近 7 日',
    weekUnit: '件 / 日',
    ...
    activitySummaryDaily: '{{date}} に {{count}} 件 / {{chars}} 文字 / {{duration}}',
    activitySummaryWeekly: '{{start}} の週に {{count}} 件 / {{chars}} 文字 / {{duration}}',
    activitySummaryCumulative: '{{start}} の週まで累計 {{count}} 件 / {{chars}} 文字 / {{duration}}',
    activityLegendLow: '少',

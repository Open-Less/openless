...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      modifierPresetsLabel: 'よく使う単キー：',
      mouseMiddleLabel: 'マウス中ボタンで音声入力',
      mouseMiddleDesc: 'ホイールクリック（中ボタン）で音声入力の開始/停止。キーボードショートカットとは独立。',
      mouseSideLabel: 'マウスサイドボタンで音声入力',
      mouseSideDesc: 'サイドボタン（進む/戻る）で音声入力の開始/停止。キーボードショートカットとは独立。',

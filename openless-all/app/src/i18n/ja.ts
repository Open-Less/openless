...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackLabel: 'Unicode SendInput 入力を許可',
      allowNonTsfFallbackDesc: 'Windows：既定で分割した Unicode SendInput を使い、失敗した場合はクリップボードへコピーします。',
    ...
    permissions: {
      ...
      windowsImeDesc: '任意の実験的 TSF IME バックエンドです。Windows では既定で Unicode SendInput を使い、プロセス内テキストサービスのハングを避けます。',
      ...
      windowsIme: {
        installed: '実験的 TSF バックエンドが登録されています。',
        notInstalled: '未登録です。OpenLess は既定で Unicode SendInput を使用します。',
        registrationBroken: '実験的 TSF 登録が破損しています。',

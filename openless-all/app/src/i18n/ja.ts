...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      escRecordingRecoveryLabel: 'Esc でキャンセルした録音を保持',
      escRecordingRecoveryDesc: '有効にすると、録音中に Esc を押したとき録音済みの音声を保持し、「録音を続ける」を短時間表示します。無効時は録音を破棄してそのままキャンセルします。既定ではオフです。',

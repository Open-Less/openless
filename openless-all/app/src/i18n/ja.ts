...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    selectionVoice: {
      title: '選択範囲の音声編集',
      hint: 'テキストを選択し、専用ショートカットを押しながら指示を話します。指示は推敲後、質問または編集に振り分けられます（置き換え前にプレビュー）。録音方式は「録音入力 → 録音方式」に従います。',
      enable: '有効化',
      enableDesc: '録音方式はグローバル設定に従います（現在：{{recordingLabel}}）。',
      hotkey: '起動ショートカット',
      hotkeyDesc: '既定は Ctrl+Shift+E。聴写・質問・推敲などと重複すると拒否されます。',
      intentMode: '意図の振り分け',
      'intentMode.auto': '自動',
      'intentMode.autoHint': '推敲後にモデルが質問か編集かを判定します。',
      'intentMode.manual': '手動',
      'intentMode.manualHint': '下の固定意図のみ使用し、自動判定しません。',
      'intentMode.heuristic': 'キーワード',
      'intentMode.heuristicHint': 'キーワードに一致すれば編集、それ以外は質問です。',
      manualIntent: '固定意図',
      'manualIntent.question': '質問',
      'manualIntent.questionHint': '質問パネルを開き、原文は変更しません。',
      'manualIntent.edit': '編集',
      'manualIntent.editHint': '編集プランを生成し、プレビュー確認後に置き換えます。',
      editKeywords: '編集キーワード',
      editKeywordsDesc: '1 行に 1 語。いずれかに一致すると編集分支になります。',
    },
    kicker: 'SETTINGS',
    title: '設定',

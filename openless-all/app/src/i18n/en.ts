...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      modifierPresetsLabel: 'Single-key presets:',
      mouseMiddleLabel: 'Middle mouse button',
      mouseMiddleDesc: 'Press the scroll wheel (middle click) to start/stop dictation. Independent of keyboard shortcuts.',
      mouseSideLabel: 'Side mouse buttons',
      mouseSideDesc: 'Press mouse side buttons (forward/back) to start/stop dictation. Independent of keyboard shortcuts.',

...
export const en: typeof zhCN = {
  ...
  localAsr: {
    ...
    sherpaDesc: 'Windows uses sherpa-onnx for on-device recognition with no ASR API key. Offline batch models return results after recording stops; streaming models are experimental and still need Windows CPU and latency validation.',
    ...
    sherpaDiagnostics: 'Last diagnostics',
    sherpaDiagPrepare: 'Load {{value}}',
    sherpaDiagTranscribe: 'Decode {{value}}',
    sherpaDiagAudio: 'Audio {{value}}',
    sherpaLanguageJa: 'Japanese ja',
    sherpaLanguageKo: 'Korean ko',
    sherpaLanguageYue: 'Cantonese yue',
    sherpaModeOffline: 'Batch',
    sherpaModeOnline: 'Streaming',
    ...
    sherpaModelZipformerStreaming: 'Zipformer Streaming bilingual (zh/en)',
    sherpaModelZipformerStreamingDesc: 'Experimental online model for partial results while recording. CPU usage and latency still need Windows validation.',

...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      autoRetainRecordingOnFailureLabel: 'Keep recording on ASR failure',
      autoRetainRecordingOnFailureDesc: 'Automatically save raw audio when transcription fails, so you can retry from History.',

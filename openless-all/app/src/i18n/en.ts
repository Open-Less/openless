...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackLabel: 'Allow Unicode SendInput insertion',
      allowNonTsfFallbackDesc: 'Windows: use paced Unicode SendInput by default; if that fails, copy the text to the clipboard.',
    ...
    permissions: {
      ...
      windowsImeDesc: 'Optional experimental TSF IME backend. Windows uses Unicode SendInput by default to avoid in-process text-service hangs.',
      ...
      windowsIme: {
        installed: 'Experimental TSF backend is registered.',
        notInstalled: 'Not registered. OpenLess uses Unicode SendInput by default.',
        registrationBroken: 'Experimental TSF registration is broken.',

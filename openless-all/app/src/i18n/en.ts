...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    permissions: {
      ...
      iosKeyboard: {
        extensionLabel: 'OpenLess Keyboard',
        enabled: 'Enabled',
        disabled: 'Not enabled (Settings → General → Keyboard)',
        appGroupLabel: 'Shared container (App Group)',
        available: 'Available',
        unavailable: 'Unavailable',
        configLabel: 'Keyboard transcription config',
        endpointPlaceholder: 'Transcription endpoint (e.g. https://api.example.com/v1)',
        keyPlaceholder: 'API Key',
        modelPlaceholder: 'Model (e.g. whisper-1)',
        promptPlaceholder: 'Transcription prompt (optional)',
        save: 'Save to keyboard',
        saved: 'Saved',
        hint: 'Config is written to the App Group for the keyboard extension. The keyboard needs Full Access for network and microphone.',
      },

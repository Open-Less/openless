...
export const en: typeof zhCN = {
  cloudSyncE2ee: {
    ...
    setPassword: 'Set sync password',
    stepEnableTitle: 'Step 1 of 3: Turn sync on',
    stepEnableDetail:
      'Use the switch. After you confirm the notice, the next step is a sync password.',
    stepPasswordTitle: 'Step 2 of 3: Set a sync password',
    stepPasswordDetail:
      'One step left. Sync starts only after you set a password. This is not done yet.',
    stepUnlockTitle: 'Step 2 of 3: Unlock this device',
    stepUnlockDetail: 'One step left. Enter the sync password to unlock this device.',
    stepClosedTitle: 'Sync is off',
    stepClosedDetail: 'The cloud backup is still there. Turn the switch on to continue.',
    stepDoneTitle: 'Step 3 of 3: Sync is ready',
    stepDoneDetail: 'This device is unlocked and sync is on.',
    stepPreparingTitle: 'Opening the next step',
    stepPreparingDetail:
      'The notice is confirmed. Next you will set a sync password. That step is not done yet.',
    stepFollowDetail: 'Use the button on this row to continue.',
    ...
    errors: {
      ...
      localData: 'This device could not prepare its data. Choose Refresh status, then try again.',
    },
  },
  cloudSync: {
    title: 'Cloud sync',
  ...
  lessComputer: {
    ...
    desktop: {
      ...
      emptyHint: 'Describe a task, tap the mic, or use your voice shortcut to get started.',
      showInspector: 'Show workspace panel',
      hideInspector: 'Hide workspace panel',
      inspectorTitle: 'Workspace',
      inspectorStatus: 'Status',
      inspectorTurn: 'This turn',
      toolCalls: 'Tool calls',
      pendingApprovals: 'Waiting for you',
      inspectorVoice: 'Voice input',
      voiceShortcutOff: 'No voice shortcut set. You can turn one on in Settings.',
      voiceModesHint:
        'Mic: your words go into the input so you can edit before sending. Voice button: sends straight to the agent when you stop.',
      copy: 'Copy',
      copied: 'Copied',
      messagePlaceholder: 'Message {{agent}}',
    },
    voice: {
      dictate: 'Dictate into the input',
      voiceMode: 'Voice mode (sends when you stop)',
      stopTask: 'Stop task',
      cancel: 'Cancel recording',
      confirmDictation: 'Finish dictation',
      ...
      startFailed: 'Could not start recording: {{message}}',
      taskCancelFailed: 'The task did not stop. Try again.',
      dictateCaption: 'Tap ✓ when done — the text goes into the input for editing · Esc to cancel',
      submitCaption: 'Tap ↑ to send straight to the agent · Esc to cancel',
      stopHint: 'Task running — tap ■ to stop',
      holdHint: 'Hold {{key}} to talk',
      toggleHint: 'Press {{key}} to start or stop talking',
      autoHint: 'Hold or tap {{key}} to talk',
    },
    title: 'Less Computer',

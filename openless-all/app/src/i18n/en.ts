...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      volcengineAppKeyLabel: 'App Key (Volcengine APP ID)',
      volcengineAccessKeyLabel: 'Access Key (Volcengine Access Token)',
      volcengineResourceIdLabel: 'Resource ID',
      volcengineMappingNote: 'OpenLess currently uses only the APP ID, Access Token, and Resource ID for Volcengine streaming ASR. Secret Key is not used in this connection. The common default value is volc.bigasr.sauc.duration.',

...
export const en: typeof zhCN = {
  ...
  selectionVoicePreview: {
    title: 'Selection Voice Edit Preview',
    subtitle: 'Editable; the original selection is replaced only after you confirm.',
    cancel: 'Cancel',
    resultLabel: 'Edited result',
    sourcePrefix: 'Original: ',
  ...
  settings: {
    ...
    selectionVoice: {
      title: 'Selection Voice Edit',
      hint: 'Select text, then hold the dedicated shortcut and speak your instruction. The instruction is polished first, then routed to Q&A or deterministic edit (preview before replace). Recording behavior follows Recording input → Recording mode.',
      enable: 'Enable',
      enableDesc: 'Recording behavior follows global settings (current: {{recordingLabel}}).',
      hotkey: 'Trigger shortcut',
      hotkeyDesc: 'Default Ctrl+Shift+E. Conflicts with dictation, Q&A, selection polish, etc. are rejected.',
      intentMode: 'Intent routing',
      'intentMode.auto': 'Auto',
      'intentMode.autoHint': 'After polishing, the model classifies question vs edit.',
      'intentMode.manual': 'Manual',
      'intentMode.manualHint': 'Always use the fixed intent below; no automatic classification.',
      'intentMode.heuristic': 'Keywords',
      'intentMode.heuristicHint': 'Edit when the instruction matches a keyword; otherwise Q&A.',
      manualIntent: 'Fixed intent',
      'manualIntent.question': 'Question',
      'manualIntent.questionHint': 'Open the Q&A panel; original text is not modified.',
      'manualIntent.edit': 'Edit',
      'manualIntent.editHint': 'Generate an edit plan and replace after preview confirmation.',
      editKeywords: 'Edit keywords',
      editKeywordsDesc: 'One keyword per line. Any match routes to the edit branch.',
    },
    kicker: 'SETTINGS',
    title: 'Settings',

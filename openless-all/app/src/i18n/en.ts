...
export const en: typeof zhCN = {
  ...
  history: {
    ...
    cancelledRecording: 'Recording cancelled · audio saved',
    cancelledRecordingHint: 'This recording has not been transcribed. Continue recording, or transcribe it now with the current speech model.',
    continueRecording: 'Continue recording',
    continuingRecording: 'Resuming…',
    continueRecordingFailed: 'Could not continue recording: {{err}}',
    startTranscription: 'Transcribe now',
    ...
    stepAsr: 'Transcribe',
    stepAsrDictionary: 'ASR vocabulary',
    dictionaryDeliveryCounts: '{{sent}} sent / {{dropped}} omitted',
    ...
    stepPolish: 'Polish',
    stepLlmDictionary: 'LLM vocabulary',
    dictionaryPrompt: 'Included in the polish prompt',
    stepInsert: 'Insert',
    chars: '{{count}} chars',
  ...
  vocab: {
    ...
    deliveryMode: 'ASR delivery: {{mode}}',
    deliveryCounts: '{{sent}} sent · {{dropped}} omitted',
    inboxTitle: 'Pending suggestions ({{count}})',
    scopeTitle: 'Entry scope',
    scopeGlobal: 'Global · permanent',
    scopeProjectTemporary: 'Current app · temporary',
    searchPlaceholder: 'Search terms or notes…',
    ...
    scopeAll: 'All scopes',
    scopePersistent: 'Permanent',
    scopeTemporaryBadge: 'Temporary',
    pin: 'Pin for ASR priority',
    unpin: 'Unpin',
    upgradeGlobal: 'Keep permanently as a global term',
    keep: 'Keep',
    corrections: {
  ...
  settings: {
    ...
    dataStorage: {
      ...
      cursorContextDesc:
        'Reads a short window around the caret while polishing. When on, that text is sent to your configured LLM provider; when off, nothing is read. Uses Accessibility on macOS, TSF on Windows, and fcitx SurroundingText on Linux. Password and sensitive input is always blocked.',
      cursorContextLlmLabel: 'Use document context for LLM polish',
      cursorContextLlmDesc: 'Reads a short window around the caret and includes it in the configured LLM request.',
      editLearningLabel: 'Suggest vocabulary from edits',
      editLearningDesc: 'Watches only the span inserted by OpenLess and always asks before saving.',
      vocabInboxLabel: 'Keep a vocabulary suggestion inbox',
      vocabInboxDesc: 'Unresolved suggestions remain locally available for seven days; turning this off clears the inbox.',
      temporaryVocabTtlLabel: 'Temporary app vocabulary lifetime (days)',
      temporaryVocabCapacityLabel: 'Temporary vocabulary capacity',
      temporaryVocabCapacityDesc: 'Evicts least-recently-used temporary terms; pinned and permanent terms are never removed by capacity.',
    },
    codingConsole: {

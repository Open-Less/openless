...
export const en: typeof zhCN = {
  ...
  onboarding: {
    ...
    kicker: 'FIRST RUN',
    intro: 'Set up hearing, recording, ASR, and LLM before your first real dictation. Most people should start with Volcengine ASR; local models are for offline or privacy-sensitive use.',
    refreshStatus: 'Refresh status',
    enterApp: 'Enter OpenLess for now',
    enterAppRaw: 'Enter with Raw mode',
    enterAppReady: 'Enter OpenLess',
    providerReady: 'Providers ready',
    providerMissing: 'Providers incomplete',
    ...
    steps: {
      microphone: {
        ...
        desc: 'Grant access and confirm input level',
      },
      shortcut: {
        title: 'Set hotkey',
        desc: 'Record it and press it once',
      },
      providers: {
        title: 'Configure ASR / LLM',
        desc: 'Cloud first, local when needed',
      },
    },
    panels: {
      microphone: {
        title: 'First, make sure OpenLess can hear you',
        desc: 'Microphone access and live input level are the first gate. This page opens system permission prompts and shows whether audio is actually coming in.',
      },
      shortcut: {
        title: 'Choose a recording hotkey that will not get in the way',
        desc: 'The default is not perfect for everyone. Record a shortcut, then press it once here so the first dictation does not start with a surprise.',
      },
      providers: {
        title: 'Choose a transcription path, then finish LLM setup',
        desc: 'New users should usually start with Volcengine ASR. Local ASR is better for offline, privacy-sensitive, or network-limited setups. Polishing, translation, and selection Q&A still need an LLM.',
      },
    },
    micPanelTitle: 'System permissions',
    micPanelDesc: 'OpenLess needs microphone access at minimum. Some platforms also need Accessibility for global hotkeys and text insertion.',
    micPermissionLabel: 'Microphone',
    micPermissionDesc: 'Captures your voice input.',
    micPermissionReady: 'OpenLess is allowed to use the microphone.',
    micTestTitle: 'Input level test',
    micTestStart: 'Start test',
    micTestStop: 'Stop test',
    micHeard: 'Audio detected',
    micListening: 'Listening',
    micWaiting: 'Waiting to test',
    micTestFailed: 'Test failed',
    micPermissionBlocked: 'Microphone access is not enabled yet. Allow OpenLess to use the microphone in system settings first.',
    shortcutPanelTitle: 'Recording hotkey',
    shortcutPanelDesc: 'Prefer a shortcut that is not used for chat send, IDE commands, or input-method switching.',
    shortcutTestTitle: 'Hotkey test',
    shortcutCurrent: 'Current recording hotkey: {{shortcut}}',
    shortcutNotSet: 'No recording hotkey is set yet.',
    shortcutTestStart: 'Test hotkey',
    shortcutListening: 'Press the current hotkey…',
    shortcutMatched: 'This hotkey was detected.',
    shortcutMissed: 'That key press did not match the current shortcut. Try again.',
    shortcutTestHint: 'Click "Test hotkey", then press the current shortcut in this window. Esc cancels.',
    hotkeyStatusUnknown: 'Listener status unknown',
    hotkeyInstalled: 'Global listener installed',
    hotkeyStarting: 'Global listener starting',
    hotkeyFailed: 'Global listener failed',
    cloudAsrTitle: 'Recommended: Volcengine ASR',
    cloudAsrDesc: 'Best fit for most new users: stable speed and stronger Chinese accuracy. Follow the guide, then paste APP ID, Access Token, and Resource ID below.',
    openVolcengineDoc: 'Open Volcengine guide',
    localAsrTitle: 'Optional: local ASR',
    localAsrDesc: 'Use this only when you need offline recognition, privacy isolation, or no cloud ASR API. First preparation downloads models; speed and accuracy depend on the machine.',
    openLocalAsrSettings: 'View local models',
    providerStatusTitle: 'Current status',
    asrStatus: 'Speech to text',
    llmStatus: 'Smart polish',
    providerSettingsTitle: 'Fill provider configuration',
    providerSettingsDesc: 'This is the provider settings area. You can save API keys, models, and local model options directly here.',
    providersTab: 'Providers',
    localModelTab: 'Local models',
    progress: 'Step {{current}} / {{total}}',
    back: 'Back',
    next: 'Next',
    statusDone: 'Done',
    statusTodo: 'To do',
    slideMicKicker: 'Step one',
    slideMicTitle: 'Test the microphone',
    slideMicDesc: 'Grant access and confirm live input.',
    slideShortcutKicker: 'Step two',
    slideShortcutTitle: 'Set the record key',
    slideShortcutDesc: 'Record a shortcut, then press it once.',
    slideAsrKicker: 'Step three',
    slideAsrTitle: 'Connect speech to text',
    slideAsrDesc: 'Online transcription is the best first path for speed and accuracy.',
    cloudAsrDescShort: 'Cloud speech to text is the best first path.',
    asrSetupTitle: 'Connect cloud speech to text',
    asrSetupDesc: '{{provider}} is recommended first. You can also choose another online service you already have keys for.',
    asrHaveKey: 'I have Volcengine account keys',
    asrProviderLabel: 'Online transcription service',
    asrConnectSelected: 'Connect selected service',
    asrOtherOnlineKey: 'Online ASR API key',
    asrAdvancedToggle: 'Advanced: Resource ID',
    asrProviderNote: 'OpenLess does not bundle shared credentials. Use your own provider account keys. Local models live in Advanced settings.',
    asrDefer: 'Connect later in Settings',
    asrSkipNote: 'Until speech-to-text is connected, recordings cannot become text.',
    saveAsr: 'Save transcription service',
    recommendedBadge: 'Recommended',
    slideLlmKicker: 'Optional',
    slideLlmTitle: 'Choose output',
    slideLlmDesc: 'Start dictation first; decide on smart polish later.',
    rawModeReady: 'Raw transcript ready',
    llmOptionalHint: 'Without smart polish, OpenLess outputs the raw transcript first.',
    llmRawTitle: 'Raw transcript first',
    llmRawDesc: 'No polish or translation. Best for getting started.',
    llmSmartTitle: 'Connect smart polish',
    llmSmartDesc: 'Add an API key when you need polish, translation, and Q&A.',
    llmHaveKey: 'Ark / OpenAI-compatible API key',
    saveLlm: 'Save smart polish',
    rawFallbackBadge: 'Skippable',
    slideDoneKicker: 'Done',
    slideDoneTitleReady: 'Ready to dictate',
    slideDoneTitleRaw: 'Start with raw transcript',
    slideDoneDescReady: 'Microphone, shortcut, and providers are ready.',
    slideDoneDescRaw: 'Without smart polish, OpenLess outputs the raw transcript first.',
    doneNeedsAsrTitle: 'Speech-to-text is still missing',
    doneNeedsAsrDesc: 'The microphone and shortcut can be ready first, but dictation needs one online transcription service.',
    doneNeedsAsrHint: 'Connect Volcengine first, or use another online ASR key you already have.',
    doneEnterAnyway: 'Enter OpenLess for now',
    llmOptionalTitle: 'Smart polish can wait',
    llmOptionalDesc: 'Without a model, OpenLess first outputs exactly what you said.',
    llmPreviewRawTitle: 'Just type what I said',
    llmPreviewRawDesc: 'Raw transcript, fastest to start.',
    llmPreviewSmartTitle: 'Polish or translate',
    llmPreviewSmartDesc: 'Needs an API key; can be enabled later.',
    rawMode: 'Raw transcript',
    available: 'Available',
    enabled: 'Enabled',
    primaryMicReady: 'Continue to shortcut',
    primaryMicGrant: 'Allow microphone',
    primaryMicSkip: 'Grant later, continue',
    primaryShortcutReady: 'Continue to transcription',
    primaryShortcutSkip: 'Set later, continue',
    primaryAsrReady: 'Continue',
    primaryAsrConnect: 'Connect transcription',
    primaryAsrSave: 'Save transcription',
    primaryAsrSkip: 'Connect later, continue',
    primaryLlmReady: 'Continue',
    primaryLlmSkip: 'Use raw transcript first',
    primaryDoneNeedsAsr: 'Connect transcription',
    doneAsrMissing: 'Connect later',
    doneRawOutput: 'Raw transcript only',
    doneSmartOutput: 'Enabled',
  },
  overview: {
    kicker: 'DASHBOARD',
  ...
  settings: {
    ...
    setup: {
      title: 'Setup guide',
      desc: 'Check the microphone, recording key, and online ASR again.',
      open: 'Open guide',
    },
    recording: {
      title: 'Recording',
    ...
    providers: {
      ...
      volcengineMappingNote: 'Secret Key is not required right now. Confirm Resource ID is volc.seedasr.sauc.duration.',
    ...
    advanced: {
      ...
      disableLocalDesc: 'Switch back to cloud ASR (defaults to Volcengine ASR).',
      disable: 'Disable',

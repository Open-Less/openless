...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    advanced: {
      ...
      localAsrDesc: 'Move transcription from cloud ASR to on-device inference. Recommended only for offline / privacy-sensitive use, or when you do not want to pay for cloud APIs.',
      localAsrWarningStrong: 'Local inference runs on CPU + Apple Silicon Accelerate; each transcription takes several seconds longer than cloud ASR, and Chinese / dialect accuracy is typically lower than Volcengine or Whisper turbo. Confirm you accept these tradeoffs before enabling.',
      qwen3Desc: 'Alibaba Qwen3-ASR weights running locally — cross-platform. Model files download from HuggingFace on first use.',
      foundryDesc: 'Microsoft Foundry Local Whisper model. Windows only.',
      enable: 'Enable',
      alreadyActive: 'Active',
      disableLocalLabel: 'Disable local ASR',
      disableLocalDesc: 'Switch back to cloud ASR (defaults to Volcengine bigasr). You will need cloud credentials configured under Providers.',
      disable: 'Disable',
      platformNotSupported: 'Local ASR model integration is not supported on this platform.',
      confirmEnableLocalTitle: 'Confirm enabling local ASR',
      confirmEnableLocalBody: 'Enabling "{{target}}" moves transcription from the cloud to local inference. Local inference is several seconds slower and typically less accurate.\n\nProceed?',
    },
    language: {

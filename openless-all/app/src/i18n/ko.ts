...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackLabel: 'Unicode SendInput 입력 허용',
      allowNonTsfFallbackDesc: 'Windows: 기본적으로 분할된 Unicode SendInput을 사용하고, 실패하면 텍스트를 클립보드에 복사합니다.',
    ...
    permissions: {
      ...
      windowsImeDesc: '선택적 실험용 TSF 입력기 백엔드입니다. Windows는 기본적으로 Unicode SendInput을 사용해 프로세스 내부 텍스트 서비스 멈춤을 피합니다.',
      ...
      windowsIme: {
        installed: '실험용 TSF 백엔드가 등록되어 있습니다.',
        notInstalled: '등록되지 않음. OpenLess는 기본적으로 Unicode SendInput을 사용합니다.',
        registrationBroken: '실험용 TSF 등록이 손상되었습니다.',

...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    selectionVoice: {
      title: '선택 영역 음성 편집',
      hint: '텍스트를 선택한 뒤 전용 단축키를 누르고 지시를 말합니다. 지시는 다듬은 뒤 질문 또는 편집으로 분기됩니다(교체 전 미리보기). 녹음 방식은 「녹음 입력 → 녹음 방식」을 따릅니다.',
      enable: '사용',
      enableDesc: '녹음 방식은 전역 설정을 따릅니다(현재: {{recordingLabel}}).',
      hotkey: '실행 단축키',
      hotkeyDesc: '기본값 Ctrl+Shift+E. 받아쓰기·질문·다듬기 등과 충돌하면 거부됩니다.',
      intentMode: '의도 분기',
      'intentMode.auto': '자동',
      'intentMode.autoHint': '다듬은 뒤 모델이 질문/편집을 판별합니다.',
      'intentMode.manual': '수동',
      'intentMode.manualHint': '아래 고정 의도만 사용하며 자동 판별하지 않습니다.',
      'intentMode.heuristic': '키워드',
      'intentMode.heuristicHint': '키워드와 일치하면 편집, 아니면 질문입니다.',
      manualIntent: '고정 의도',
      'manualIntent.question': '질문',
      'manualIntent.questionHint': '질문 패널을 열고 원문은 수정하지 않습니다.',
      'manualIntent.edit': '편집',
      'manualIntent.editHint': '편집 계획을 생성하고 미리보기 확인 후 교체합니다.',
      editKeywords: '편집 키워드',
      editKeywordsDesc: '한 줄에 하나씩. 하나라도 일치하면 편집 분기로 갑니다.',
    },
    kicker: 'SETTINGS',
    title: '설정',

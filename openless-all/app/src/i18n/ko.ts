...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      modifierPresetsLabel: '자주 쓰는 단일 키:',
      mouseMiddleLabel: '마우스 휠 버튼으로 음성 입력',
      mouseMiddleDesc: '휠 클릭(가운데 버튼)으로 음성 입력 시작/중지. 키보드 단축키와 독립적입니다.',
      mouseSideLabel: '마우스 측면 버튼으로 음성 입력',
      mouseSideDesc: '측면 버튼(앞으로/뒤로)으로 음성 입력 시작/중지. 키보드 단축키와 독립적입니다.',

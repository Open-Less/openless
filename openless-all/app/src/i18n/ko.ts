...
export const ko: typeof zhCN = {
  ...
  overview: {
    ...
    metricTotal: '오늘 누적 기록',
    metricTotalTrend: '로컬 보관',
    metricTotalExceeded: '로컬 보관 최대 개수 초과',
    metricTotalArchived: '로컬에 {{count}}개 보관됨',
    weekTitle: '최근 7일',
    weekUnit: '건/일',
    activityTitle: '연간 활동',
    ...
    activitySummaryDaily: '{{date}} 사용 {{count}}건 / {{chars}}자 / {{duration}}',
    activitySummaryWeekly: '{{start}} 주간 사용 {{count}}건 / {{chars}}자 / {{duration}}',
    activitySummaryCumulative: '{{start}} 주까지 누적 사용 {{count}}건 / {{chars}}자 / {{duration}}',

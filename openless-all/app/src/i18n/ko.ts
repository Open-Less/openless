...
export const ko: typeof zhCN = {
  ...
  localAsr: {
    ...
    sherpaDesc: 'Windows는 sherpa-onnx로 기기 내 인식을 수행하며 ASR API 키가 필요 없습니다. 오프라인 일괄 모델은 녹음이 끝난 뒤 결과를 반환하고, 스트리밍 모델은 실험적이며 CPU 사용량과 지연 시간 검증이 필요합니다.',
    ...
    sherpaDiagnostics: '최근 진단',
    sherpaDiagPrepare: '로드 {{value}}',
    sherpaDiagTranscribe: '추론 {{value}}',
    sherpaDiagAudio: '오디오 {{value}}',
    sherpaLanguageJa: '일본어 ja',
    sherpaLanguageKo: '한국어 ko',
    sherpaLanguageYue: '광둥어 yue',
    sherpaModeOffline: '일괄',
    sherpaModeOnline: '스트리밍',
    ...
    sherpaModelZipformerStreaming: 'Zipformer 스트리밍 중영 이중 언어',
    sherpaModelZipformerStreamingDesc: '녹음 중 partial 을 반환하는 실험적 온라인 모델입니다. CPU 사용량과 지연 시간은 Windows 실제 기기 검증이 필요합니다.',
    mirrorLabel: '다운로드 미러',

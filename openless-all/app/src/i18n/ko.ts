...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    permissions: {
      ...
      iosKeyboard: {
        extensionLabel: 'OpenLess 키보드',
        enabled: '활성화됨',
        disabled: '비활성화 (설정 → 일반 → 키보드)',
        appGroupLabel: '공유 컨테이너 (App Group)',
        available: '사용 가능',
        unavailable: '사용할 수 없음',
        configLabel: '전사 설정',
        endpointPlaceholder: '엔드포인트 (예: https://api.example.com/v1)',
        keyPlaceholder: 'API 키',
        modelPlaceholder: '모델 (예: whisper-1)',
        promptPlaceholder: '전사 프롬프트 (선택)',
        save: '키보드에 저장',
        saved: '저장됨',
        hint: '설정은 App Group에 기록되어 키보드 확장이 읽습니다. 네트워크와 마이크에는 "전체 접근 허용"이 필요합니다.',
      },

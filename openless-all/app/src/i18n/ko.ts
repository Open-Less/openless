...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      escRecordingRecoveryLabel: 'Esc로 취소한 녹음 보관',
      escRecordingRecoveryDesc: '켜면 녹음 중 Esc를 눌렀을 때 이미 녹음한 오디오를 보관하고 잠시 "녹음 계속" 항목을 표시합니다. 끄면 녹음을 바로 취소하고 삭제합니다. 기본값은 꺼짐입니다.',

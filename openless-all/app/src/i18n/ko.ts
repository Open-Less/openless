...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      autoRetainRecordingOnFailureLabel: '인식 실패 시 녹음 보존',
      autoRetainRecordingOnFailureDesc: 'ASR 인식 실패 시 자동으로 녹음을 저장하여 기록 페이지에서 다시 인식할 수 있습니다.',

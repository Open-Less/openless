...
export const ko: typeof zhCN = {
  ...
  history: {
    ...
    cancelledRecording: '녹음 취소됨 · 오디오 저장됨',
    cancelledRecordingHint: '이 녹음은 아직 텍스트로 변환되지 않았습니다. 녹음을 계속하거나 현재 음성 모델로 바로 변환할 수 있습니다.',
    continueRecording: '녹음 계속',
    continuingRecording: '재개 중…',
    continueRecordingFailed: '녹음을 계속하지 못했습니다: {{err}}',
    startTranscription: '텍스트 변환 시작',
    pendingTranscription: '변환 대기',
    transcribedOnly: '변환됨',
    rawLabel: '원문',
    rawEmpty: '(비어 있음)',
    ...
    stepAsr: '인식',
    stepAsrDictionary: 'ASR 사전',
    dictionaryDeliveryCounts: '{{sent}}개 전송 / {{dropped}}개 제외',
    multimodalPipeline: '멀티모달',
    stepAsrHint: '키를 뗀 후 인식 결과를 기다린 시간. 스트리밍 인식은 녹음 중에 변환하므로 보통 녹음 시간보다 훨씬 짧습니다.',
    stepPolish: '다듬기',
    stepLlmDictionary: 'LLM 사전',
    dictionaryPrompt: '다듬기 프롬프트에 포함됨',
    stepInsert: '삽입',
    chars: '{{count}}자',
  ...
  vocab: {
    ...
    deliveryMode: 'ASR 전달: {{mode}}',
    deliveryCounts: '{{sent}}개 전송 · {{dropped}}개 제외',
    inboxTitle: '대기 중인 제안 ({{count}})',
    scopeTitle: '단어 범위',
    scopeGlobal: '전체 · 영구',
    scopeProjectTemporary: '현재 앱 · 임시',
    searchPlaceholder: '단어나 메모 검색…',
    sourceFilter: '출처로 필터',
    sourceAll: '모든 출처',
    sourceManual: '수동',
    sourceLearned: '학습',
    ...
    scopeAll: '모든 범위',
    scopePersistent: '영구',
    scopeTemporaryBadge: '임시',
    pin: '고정하고 ASR 우선순위 높이기',
    unpin: '고정 해제',
    upgradeGlobal: '전체 영구 단어로 보관',
    keep: '영구 보관',
    corrections: {
      title: '교정 규칙',
  ...
  settings: {
    ...
    dataStorage: {
      ...
      cursorContextDesc:
        '다듬을 때 커서 주변의 짧은 텍스트를 읽습니다. 켜면 설정된 LLM 제공자로 전송하고, 끄면 읽지 않습니다. macOS는 Accessibility, Windows는 TSF, Linux는 fcitx SurroundingText를 사용하며 비밀번호와 민감한 입력은 항상 차단합니다.',
      cursorContextLlmLabel: '문서 문맥을 LLM 다듬기에 사용',
      cursorContextLlmDesc: '커서 주변의 짧은 범위를 설정된 LLM 요청에 포함합니다.',
      editLearningLabel: '수정 내용에서 단어 제안',
      editLearningDesc: 'OpenLess가 이번에 삽입한 범위만 관찰하며 저장 전 항상 확인합니다.',
      vocabInboxLabel: '단어 제안 받은편지함 유지',
      vocabInboxDesc: '처리하지 않은 제안을 로컬에 7일간 보관하며, 끄면 받은편지함을 비웁니다.',
      temporaryVocabTtlLabel: '앱별 임시 단어 유지 기간(일)',
      temporaryVocabCapacityLabel: '임시 단어 용량',
      temporaryVocabCapacityDesc: '가장 오래 사용하지 않은 임시 단어부터 제거하며 고정 및 영구 단어는 제거하지 않습니다.',
    },
    codingConsole: {
      title: 'Claude 콘솔',

...
export const ko: typeof zhCN = {
  ...
  cloudSyncE2ee: {
    ...
    enable: '암호화 동기화 사용',
    setPassword: '동기화 비밀번호 설정',
    stepEnableTitle: '1/3단계: 동기화 켜기',
    stepEnableDetail: '스위치를 사용하세요. 확인 후 다음 단계는 동기화 비밀번호입니다.',
    stepPasswordTitle: '2/3단계: 동기화 비밀번호 설정',
    stepPasswordDetail: '한 단계 남았습니다. 비밀번호를 설정해야 동기화가 시작됩니다.',
    stepUnlockTitle: '2/3단계: 이 기기 잠금 해제',
    stepUnlockDetail: '한 단계 남았습니다. 동기화 비밀번호로 이 기기의 잠금을 해제하세요.',
    stepClosedTitle: '동기화가 꺼져 있음',
    stepClosedDetail: '클라우드 백업은 그대로입니다. 계속하려면 위 스위치를 켜세요.',
    stepDoneTitle: '3/3단계: 동기화 준비됨',
    stepDoneDetail: '이 기기는 잠금 해제되었고 동기화가 켜져 있습니다.',
    stepPreparingTitle: '다음 단계를 여는 중',
    stepPreparingDetail:
      '확인을 마쳤습니다. 이제 동기화 비밀번호를 설정합니다. 아직 끝나지 않았습니다.',
    stepFollowDetail: '이 줄의 버튼으로 계속하세요.',
    refresh: '상태 새로고침',
    loading: '동기화 상태 확인 중…',
    signIn: 'GitHub로 로그인',
    signOut: '로그아웃',
    ...
    errors: {
      ...
      localData: '이 기기의 데이터를 준비하지 못했습니다. 상태 새로고침을 누른 뒤 다시 시도하세요.',
    },
  },
  cloudSync: {
    title: '클라우드 동기화',
  ...
  lessComputer: {
    ...
    desktop: {
      ...
      apiCost: '이번 API 비용',
      emptyHint: '작업을 입력하거나, 마이크를 누르거나, 음성 단축키로 시작하세요.',
      showInspector: '작업 패널 보기',
      hideInspector: '작업 패널 숨기기',
      inspectorTitle: '작업 공간',
      inspectorStatus: '상태',
      inspectorTurn: '이번 턴',
      toolCalls: '도구 호출',
      pendingApprovals: '확인 대기',
      inspectorVoice: '음성 입력',
      voiceShortcutOff: '음성 단축키가 설정되지 않았습니다. 설정에서 켤 수 있습니다.',
      voiceModesHint:
        '마이크: 말한 내용이 입력창에 들어가 수정한 뒤 보낼 수 있습니다. 음성 버튼: 말을 멈추면 바로 에이전트에 보냅니다.',
      copy: '복사',
      copied: '복사됨',
      messagePlaceholder: '{{agent}}에게 메시지',
    },
    voice: {
      dictate: '입력창에 받아쓰기',
      voiceMode: '음성 모드(멈추면 전송)',
      stopTask: '작업 중지',
      cancel: '녹음 취소',
      confirmDictation: '받아쓰기 완료',
      stopAndSend: '멈추고 보내기',
      listening: '듣는 중…',
      starting: '마이크 준비 중…',
      transcribing: '받아쓰는 중…',
      empty: '들린 내용이 없습니다. 다시 말씀해 주세요.',
      failed: '음성 인식에 실패했습니다. 다시 시도해 주세요.',
      startFailed: '녹음을 시작할 수 없습니다: {{message}}',
      taskCancelFailed: '작업이 중지되지 않았습니다. 다시 시도해 주세요.',
      dictateCaption:
        '다 말했으면 ✓를 누르세요. 텍스트가 입력창에 들어가 수정할 수 있습니다 · Esc로 취소',
      submitCaption: '↑를 누르면 바로 에이전트에 보냅니다 · Esc로 취소',
      stopHint: '작업 실행 중: ■를 눌러 중지',
      holdHint: '{{key}}를 누른 채 말하기',
      toggleHint: '{{key}}를 눌러 시작 또는 종료',
      autoHint: '{{key}}를 길게 또는 짧게 눌러 말하기',
    },
    title: 'Less Computer',

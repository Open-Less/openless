...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      tencentCloudNote: 'Tencent Cloud 음성 인식 API 자격 증명을 사용합니다. 기본 Hy-ASR-3.0-preview는 중국어, 영어 및 20개 방언을 지원합니다. Preview는 60초 이하의 16kHz 모노 PCM만 지원하며 컨텍스트 및 핫워드 강화는 아직 지원하지 않습니다.',

...
export const zhTW: typeof zhCN = {
  ...
  onboarding: {
    ...
    kicker: 'FIRST RUN',
    intro: '先把能不能聽、怎麼開始錄、用哪條 ASR / LLM 路線一次配清楚。多數用戶建議先用火山 ASR，本地模型保留給離線或隱私敏感場景。',
    refreshStatus: '刷新狀態',
    enterApp: '先進入 OpenLess',
    enterAppRaw: '先用原文模式進入',
    enterAppReady: '進入 OpenLess',
    providerReady: '服務已就緒',
    providerMissing: '服務未完成',
    permissionReady: '已就緒',
    permissionPending: '待處理',
    ...
    panels: {
      microphone: {
        title: '先確認 OpenLess 聽得到你',
        desc: '麥克風權限和輸入電平是第一道門。這裏會直接拉起系統授權，並用實時電平條確認設備有聲音。',
      },
      shortcut: {
        title: '設置一個不會誤觸的錄音快捷鍵',
        desc: '默認快捷鍵不是每個人都順手。先錄製，再在這個窗口裏按一次確認，後面真正聽寫時就少踩坑。',
      },
      providers: {
        title: '選擇轉寫路線，再補齊 LLM',
        desc: '日常新手默認走火山 ASR 更穩；本地 ASR 更適合離線、隱私敏感或網絡受限。潤色、翻譯和劃詞問答還需要 LLM。',
      },
    },
    micPanelTitle: '系統權限',
    micPanelDesc: 'OpenLess 至少需要麥克風權限；部分平台還需要輔助功能來監聽全局快捷鍵和寫入文本。',
    micPermissionLabel: '麥克風',
    micPermissionDesc: '用於捕獲你的語音輸入。',
    micPermissionReady: '已允許 OpenLess 使用麥克風。',
    micTestTitle: '輸入電平測試',
    micTestStart: '開始測試',
    micTestStop: '停止測試',
    micHeard: '已聽到聲音',
    ...
    micWaiting: '等待測試',
    micTestFailed: '測試失敗',
    micPermissionBlocked: '麥克風權限還未打開，請先在系統設置裏允許 OpenLess 使用麥克風。',
    shortcutPanelTitle: '錄音快捷鍵',
    shortcutPanelDesc: '推薦使用不參與聊天送出、IDE 命令或系統輸入法切換的按鍵組合。',
    shortcutTestTitle: '快捷鍵測試',
    shortcutCurrent: '當前錄音快捷鍵：{{shortcut}}',
    shortcutNotSet: '還沒有設置錄音快捷鍵。',
    shortcutTestStart: '測試快捷鍵',
    shortcutListening: '按下當前快捷鍵…',
    shortcutMatched: '已識別到這組快捷鍵。',
    shortcutMissed: '這次按鍵沒有匹配當前設置，請再試一次。',
    shortcutTestHint: '點「測試快捷鍵」後，在此窗口按一次當前組合鍵。Esc 可取消。',
    hotkeyStatusUnknown: '監聽狀態未知',
    hotkeyInstalled: '全局監聽已安裝',
    hotkeyStarting: '全局監聽啟動中',
    hotkeyFailed: '全局監聽異常',
    cloudAsrTitle: '推薦：火山 ASR',
    cloudAsrDesc: '適合絕大多數新用戶，識別速度和中文準確率更穩。按文檔創建應用後，把 APP ID、Access Token、Resource ID 填到下方。',
    openVolcengineDoc: '打開火山文檔',
    localAsrTitle: '按需：本地 ASR',
    localAsrDesc: '僅建議離線、隱私敏感或不想使用雲端 ASR API 時開啟。首次準備會下載模型，速度和準確率取決於機器。',
    openLocalAsrSettings: '查看本地模型',
    providerStatusTitle: '當前狀態',
    asrStatus: '語音轉文字',
    llmStatus: '智能整理',
    providerSettingsTitle: '填寫服務商配置',
    providerSettingsDesc: '下方就是設置頁的服務商區，可直接保存 API Key、模型和本地模型選項。',
    providersTab: '服務商',
    localModelTab: '本地模型',
    ...
    slideMicKicker: '第一步',
    slideMicTitle: '先試麥克風',
    slideMicDesc: '確認系統授權，並看見真實輸入電平。',
    slideShortcutKicker: '第二步',
    slideShortcutTitle: '設定錄音鍵',
    slideShortcutDesc: '錄一個順手的快捷鍵，再按一次確認。',
    slideAsrKicker: '第三步',
    slideAsrTitle: '連接語音轉文字',
    slideAsrDesc: '優先使用線上轉寫，速度和準確率更適合新使用者。',
    cloudAsrDescShort: '推薦新使用者先用雲端語音轉文字。',
    asrSetupTitle: '連接雲端語音轉文字',
    asrSetupDesc: '推薦先連接 {{provider}}。也可以選擇你已有密鑰的其他線上轉寫服務。',
    asrHaveKey: '我有火山帳號密鑰',
    asrProviderLabel: '線上轉寫服務',
    asrConnectSelected: '連接所選服務',
    asrOtherOnlineKey: '線上 ASR API Key',
    asrAdvancedToggle: '進階：Resource ID',
    asrProviderNote: 'OpenLess 不內建公益憑據，需要使用你自己的服務商帳號密鑰。本地模型在設定的進階頁裡按需開啟。',
    asrDefer: '稍後在設定裡連接',
    asrSkipNote: '語音轉文字服務沒連好前，錄音還不能變成文字。',
    saveAsr: '保存轉寫服務',
    recommendedBadge: '推薦',
    slideLlmKicker: '可選',
    slideLlmTitle: '選擇輸出方式',
    slideLlmDesc: '先開始聽寫，之後再決定要不要智能整理。',
    rawModeReady: '原始轉寫可用',
    llmOptionalHint: '不連接智能整理時，會先只輸出原始轉寫。',
    llmRawTitle: '先只輸出原始轉寫',
    llmRawDesc: '不潤色、不翻譯，適合先跑通。',
    llmSmartTitle: '連接智能整理',
    llmSmartDesc: '需要潤色、翻譯和問答時再填 API Key。',
    llmHaveKey: 'Ark / OpenAI 相容 API Key',
    saveLlm: '保存智能整理',
    rawFallbackBadge: '可跳過',
    slideDoneKicker: '完成',
    slideDoneTitleReady: '可以開始聽寫了',
    slideDoneTitleRaw: '先用原始轉寫',
    slideDoneDescReady: '麥克風、快捷鍵和服務商已就緒。',
    slideDoneDescRaw: '沒有智能整理時，會自動只輸出原始轉寫。',
    doneNeedsAsrTitle: '還差語音轉文字服務',
    doneNeedsAsrDesc: '麥克風和快捷鍵可以先準備好，但要開始聽寫還需要連接一個線上轉寫服務。',
    doneNeedsAsrHint: '建議先連接火山或你已有密鑰的線上 ASR。',
    doneEnterAnyway: '先進入 OpenLess',
    llmOptionalTitle: '智能整理可以稍後開啟',
    llmOptionalDesc: '不連接模型時，OpenLess 會先只輸出你說話的原文。',
    llmPreviewRawTitle: '只把我說的話打出來',
    llmPreviewRawDesc: '原始轉寫，最快跑通。',
    llmPreviewSmartTitle: '順手潤色或翻譯',
    llmPreviewSmartDesc: '需要 API Key，可之後再開。',
    rawMode: '原始轉寫',
    available: '可使用',
    enabled: '已啟用',
    primaryMicReady: '繼續設定快捷鍵',
    primaryMicGrant: '允許麥克風',
    primaryMicSkip: '稍後授權，繼續',
    primaryShortcutReady: '繼續連接轉寫',
    primaryShortcutSkip: '稍後設定，繼續',
    primaryAsrReady: '繼續',
    primaryAsrConnect: '連接轉寫服務',
    primaryAsrSave: '保存轉寫服務',
    primaryAsrSkip: '稍後連接，繼續',
    primaryLlmReady: '繼續',
    primaryLlmSkip: '先用原始轉寫',
    primaryDoneNeedsAsr: '連接轉寫服務',
    doneAsrMissing: '稍後連接',
    doneRawOutput: '只輸出原始轉寫',
    doneSmartOutput: '已開啟',
  },
  overview: {
    kicker: 'DASHBOARD',
  ...
  settings: {
    ...
    providers: {
      ...
      volcengineMappingNote: 'Secret Key 目前無需填寫。請確認 Resource ID 為 volc.seedasr.sauc.duration。',
    ...
    advanced: {
      ...
      disableLocalDesc: '切回雲端 ASR（預設火山引擎 ASR）。',
      disable: '停用',

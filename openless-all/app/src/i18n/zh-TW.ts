...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackLabel: '允許 Unicode SendInput 輸入',
      allowNonTsfFallbackDesc: 'Windows：預設使用分批 Unicode SendInput；如果失敗，再複製到剪貼簿。',
    ...
    permissions: {
      ...
      windowsImeDesc: '可選的實驗性 TSF 輸入法後端。Windows 預設使用 Unicode SendInput，避免進程內文字服務卡死。',
      ...
      windowsIme: {
        installed: '實驗性 TSF 後端已註冊。',
        notInstalled: '未註冊。OpenLess 預設使用 Unicode SendInput。',
        registrationBroken: '實驗性 TSF 註冊已損壞。',

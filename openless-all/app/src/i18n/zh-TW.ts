...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    selectionWorkspace: {
      ...
      autoIntent: '自動判斷意圖',
      autoIntentDesc: '開啟後優先用關鍵詞/AI 判斷提問或編輯；含「翻譯」「替換」等會走編輯。',
      editKeywords: '編輯關鍵詞',
    ...
    selectionVoice: {
      title: '選區語音編輯',
      hint: '選中文字後按住專用快捷鍵口述指令：先潤色指令，再自動分流到追問或確定性編輯（預覽確認後替換）。錄音觸發方式跟隨「錄音輸入 → 錄音方式」。',
      enable: '啟用',
      enableDesc: '錄音方式跟隨全域設定（目前：{{recordingLabel}}）。',
      hotkey: '觸發快捷鍵',
      hotkeyDesc: '預設 Ctrl+Shift+E；與聽寫、追問、選區潤色等快捷鍵衝突時會被拒絕。',
      intentMode: '意圖分流',
      'intentMode.auto': '自動',
      'intentMode.autoHint': '潤色指令後由模型判斷是提問還是編輯。',
      'intentMode.manual': '手動',
      'intentMode.manualHint': '始終按下方固定意圖執行，不再自動判斷。',
      'intentMode.heuristic': '關鍵詞',
      'intentMode.heuristicHint': '指令命中關鍵詞列表時走編輯，否則走提問。',
      manualIntent: '固定意圖',
      'manualIntent.question': '提問',
      'manualIntent.questionHint': '打開追問面板回答，不修改原文。',
      'manualIntent.edit': '編輯',
      'manualIntent.editHint': '生成編輯計畫並在預覽窗確認後替換。',
      editKeywords: '編輯關鍵詞',
      editKeywordsDesc: '每行一個；命中任一關鍵詞即走編輯分支。',
    },
    kicker: 'SETTINGS',
    title: '設置',

...
export const zhTW: typeof zhCN = {
  ...
  history: {
    ...
    cancelledRecording: '錄音已取消 · 音訊已保留',
    cancelledRecordingHint: '這段錄音尚未轉寫。可以繼續錄音，或直接使用目前的辨識模型開始轉寫。',
    continueRecording: '繼續錄音',
    continuingRecording: '正在恢復…',
    continueRecordingFailed: '繼續錄音失敗：{{err}}',
    startTranscription: '開始轉寫',
    pendingTranscription: '待轉寫',
    transcribedOnly: '已轉寫',
    rawLabel: '原文',
    rawEmpty: '（空）',
    ...
    stepAsr: '辨識',
    stepAsrDictionary: 'ASR 詞典',
    dictionaryDeliveryCounts: '傳送 {{sent}} / 省略 {{dropped}}',
    multimodalPipeline: '多模態',
    stepAsrHint: '放開按鍵後等待辨識結果的耗時。串流辨識邊錄邊轉，此值通常遠小於錄音時長。',
    stepPolish: '潤飾',
    stepLlmDictionary: 'LLM 詞典',
    dictionaryPrompt: '已加入潤飾提示詞',
    stepInsert: '插入',
    chars: '{{count}} 字',
    vocabHits: '{{count}} 個熱詞',
    inserted: '已插入',
  ...
  vocab: {
    ...
    deliveryMode: 'ASR 投遞：{{mode}}',
    deliveryCounts: '傳送 {{sent}} · 省略 {{dropped}}',
    inboxTitle: '待處理建議（{{count}}）',
    scopeTitle: '詞條作用域',
    scopeGlobal: '全域長期',
    scopeProjectTemporary: '目前應用程式 · 暫存',
    searchPlaceholder: '搜尋詞語或備註…',
    sourceFilter: '依來源篩選',
    sourceAll: '全部來源',
    sourceManual: '手動',
    sourceLearned: '學習',
    ...
    scopeAll: '全部作用域',
    scopePersistent: '長期',
    scopeTemporaryBadge: '暫存',
    pin: '固定並提高 ASR 優先級',
    unpin: '取消固定',
    upgradeGlobal: '升級為全域長期詞條',
    keep: '長期保留',
    corrections: {
      title: '糾正規則',
  ...
  settings: {
    ...
    dataStorage: {
      ...
      cursorContextDesc:
        '潤稿時讀取游標附近的一小段文字。開啟後會隨請求送給設定的 LLM 服務商；關閉時完全不讀取。macOS 使用輔助使用，Windows 使用 TSF，Linux 使用 fcitx SurroundingText；密碼與敏感輸入始終不讀。',
      cursorContextLlmLabel: '將文件上下文用於 LLM 潤飾',
      cursorContextLlmDesc: '讀取游標附近的短文字，並隨請求傳送給已設定的 LLM。',
      editLearningLabel: '從手動修改中建議詞條',
      editLearningDesc: '只觀察 OpenLess 本次插入的文字範圍，儲存前始終需要確認。',
      vocabInboxLabel: '保留詞條建議收件匣',
      vocabInboxDesc: '未處理建議在本機保留 7 天；關閉後立即清空。',
      temporaryVocabTtlLabel: '暫存應用程式詞條生命週期（天）',
      temporaryVocabCapacityLabel: '暫存詞條容量',
      temporaryVocabCapacityDesc: '依最近使用順序淘汰；固定詞條與長期詞條不會因容量被刪除。',
    },
    codingConsole: {
      title: 'Claude 主控台',

...
export const zhTW: typeof zhCN = {
  ...
  localAsr: {
    ...
    sherpaDesc: 'Windows 使用 sherpa-onnx 在本機識別，無需 ASR API Key。離線批次模型停止錄音後才出結果，流式模型為實驗能力，CPU 佔用和延遲仍需驗證。',
    ...
    sherpaDiagnostics: '最近一次診斷',
    sherpaDiagPrepare: '載入 {{value}}',
    sherpaDiagTranscribe: '推理 {{value}}',
    sherpaDiagAudio: '音訊 {{value}}',
    sherpaLanguageJa: '日語 ja',
    sherpaLanguageKo: '韓語 ko',
    sherpaLanguageYue: '粵語 yue',
    sherpaModeOffline: '批次',
    sherpaModeOnline: '流式',
    ...
    sherpaModelZipformerStreaming: 'Zipformer 流式中英雙語',
    sherpaModelZipformerStreamingDesc: '實驗性線上模型，錄音中輸出即時 partial；CPU 佔用和延遲仍需 Windows 真機驗證。',
    mirrorLabel: '下載鏡像源',

...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      modifierPresetsLabel: '常用單鍵：',
      mouseMiddleLabel: '滑鼠中鍵喚起識別',
      mouseMiddleDesc: '按下滑鼠滾輪（中鍵）開始/停止語音識別，與鍵盤快捷鍵獨立。',
      mouseSideLabel: '滑鼠側鍵喚起識別',
      mouseSideDesc: '按下滑鼠側鍵（前進/後退）開始/停止語音識別，與鍵盤快捷鍵獨立。',

...
export const zhTW: typeof zhCN = {
  ...
  overview: {
    ...
    metricTotalExceeded: '已超過本機存檔最大個數',
    metricTotalArchived: '本機已存檔{{count}}條',
    weekTitle: '近 7 天',
    weekUnit: '條數 / 天',
    activityTitle: '年度活動',
    ...
    activitySummaryDaily: '{{date}} 使用了 {{count}} 條 / {{chars}} 字 / {{duration}}',
    activitySummaryWeekly: '{{start}} 當週使用了 {{count}} 條 / {{chars}} 字 / {{duration}}',
    activitySummaryCumulative: '截至 {{start}} 當週累計使用了 {{count}} 條 / {{chars}} 字 / {{duration}}',
    activityLegendLow: '少',
  ...
  settings: {
    ...
    recording: {
      ...
      historyRetentionDesc: '超過保留天數的歷史在寫入新條目時被清理；0 / 留空 = 不按時間清理。',
      historyMaxEntriesLabel: '歷史條數上限',
      historyMaxEntriesDesc: '本地保留會話上限，0 / 留空 = 不按條數清理。',

...
export const zhCN = {
  ...
  localAsr: {
    ...
    sherpaDesc: 'Windows 使用 sherpa-onnx 在本机识别，无需 ASR API Key。离线批量模型停止录音后才出结果，流式模型为实验能力，CPU 占用和延迟仍需验证。',
    ...
    sherpaModelZipformerStreaming: 'Zipformer 流式中英双语',
    sherpaModelZipformerStreamingDesc: '实验性在线模型，录音中输出实时 partial；CPU 占用和延迟仍需 Windows 真机验证。',
    mirrorLabel: '下载镜像源',

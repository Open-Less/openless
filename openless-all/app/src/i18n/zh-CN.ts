...
export const zhCN = {
  ...
  settings: {
    ...
    selectionVoice: {
      title: '选区语音编辑',
      hint: '选中文字后按住专用快捷键口述指令：先润色指令，再自动分流到追问或确定性编辑（预览确认后替换）。录音触发方式跟随「录音输入 → 录音方式」。',
      enable: '启用',
      enableDesc: '录音方式跟随全局设置（当前：{{recordingLabel}}）。',
      hotkey: '触发快捷键',
      hotkeyDesc: '默认 Ctrl+Shift+E；与听写、追问、选区润色等快捷键冲突时会被拒绝。',
      intentMode: '意图分流',
      'intentMode.auto': '自动',
      'intentMode.autoHint': '润色指令后由模型判断是提问还是编辑。',
      'intentMode.manual': '手动',
      'intentMode.manualHint': '始终按下方固定意图执行，不再自动判断。',
      'intentMode.heuristic': '关键词',
      'intentMode.heuristicHint': '指令命中关键词列表时走编辑，否则走提问。',
      manualIntent: '固定意图',
      'manualIntent.question': '提问',
      'manualIntent.questionHint': '打开追问面板回答，不修改原文。',
      'manualIntent.edit': '编辑',
      'manualIntent.editHint': '生成编辑计划并在预览窗确认后替换。',
      editKeywords: '编辑关键词',
      editKeywordsDesc: '每行一个；命中任一关键词即走编辑分支。',
    },
    kicker: 'SETTINGS',
    title: '设置',

...
export const zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      modifierPresetsLabel: '常用单键：',
      mouseMiddleLabel: '鼠标中键唤起识别',
      mouseMiddleDesc: '按下鼠标滚轮（中键）开始/停止语音识别，与键盘快捷键独立。',
      mouseSideLabel: '鼠标侧键唤起识别',
      mouseSideDesc: '按下鼠标侧键（前进/后退）开始/停止语音识别，与键盘快捷键独立。',

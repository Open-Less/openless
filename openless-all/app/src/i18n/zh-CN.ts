...
export const zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      volcengineAppKeyLabel: 'App Key（对应火山 APP ID）',
      volcengineAccessKeyLabel: 'Access Key（对应火山 Access Token）',
      volcengineResourceIdLabel: 'Resource ID（资源 ID）',
      volcengineMappingNote: 'OpenLess 当前的 Volcengine 流式 ASR 只使用 APP ID、Access Token 和 Resource ID。Secret Key 在这条连接里不会被填写。常用默认值为 volc.bigasr.sauc.duration。',
      fillDefault: '填入默认值',
      readFailed: '读取失败',
    },
    shortcuts: {

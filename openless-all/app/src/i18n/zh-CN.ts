...
export const zhCN = {
  ...
  history: {
    ...
    cancelledRecording: '录音已取消 · 音频已保留',
    cancelledRecordingHint: '这段录音尚未转写。可以继续录音，或直接使用当前识别模型开始转写。',
    continueRecording: '继续录音',
    continuingRecording: '正在恢复…',
    continueRecordingFailed: '继续录音失败：{{err}}',
    startTranscription: '开始转写',
    pendingTranscription: '待转写',
    transcribedOnly: '已转写',
    rawLabel: '原文',
    rawEmpty: '（空）',
    ...
    stepAsr: '识别',
    stepAsrDictionary: 'ASR 词典',
    dictionaryDeliveryCounts: '发送 {{sent}} / 省略 {{dropped}}',
    multimodalPipeline: '多模态',
    stepAsrHint: '松键后等待识别结果的耗时。流式识别边录边转，此值通常远小于录音时长。',
    stepPolish: '润色',
    stepLlmDictionary: 'LLM 词典',
    dictionaryPrompt: '已加入润色提示词',
    stepInsert: '插入',
    chars: '{{count}} 字',
    vocabHits: '{{count}} 个热词',
    inserted: '已插入',
  ...
  vocab: {
    ...
    deliveryMode: 'ASR 投递：{{mode}}',
    deliveryCounts: '发送 {{sent}} · 省略 {{dropped}}',
    inboxTitle: '待处理建议（{{count}}）',
    scopeTitle: '词条作用域',
    scopeGlobal: '全局长期',
    scopeProjectTemporary: '当前应用 · 临时',
    searchPlaceholder: '搜索词语或备注…',
    sourceFilter: '按来源筛选',
    sourceAll: '全部来源',
    sourceManual: '手工',
    sourceLearned: '学习',
    ...
    scopeAll: '全部作用域',
    scopePersistent: '长期',
    scopeTemporaryBadge: '临时',
    pin: '固定并提高 ASR 优先级',
    unpin: '取消固定',
    upgradeGlobal: '升级为全局长期词条',
    keep: '长期保留',
    corrections: {
      title: '纠正规则',
  ...
  settings: {
    ...
    dataStorage: {
      ...
      cursorContextDesc:
        '润色时读取你正在写的那篇文档中光标附近的短文本。开启后这段文字会随请求发送给你配置的 LLM 服务商；关闭时一个字都不读。macOS 使用辅助功能，Windows 使用 TSF，Linux 使用 fcitx SurroundingText；密码与敏感输入始终不读。',
      cursorContextLlmLabel: '将文档上下文用于 LLM 润色',
      cursorContextLlmDesc: '读取光标附近的短窗口，并随请求发送给已配置的 LLM。',
      editLearningLabel: '从手改中建议词条',
      editLearningDesc: '只观察 OpenLess 本次插入的文本范围，保存前始终需要确认。',
      vocabInboxLabel: '保留词条建议收件箱',
      vocabInboxDesc: '未处理建议在词汇表页本地保留 7 天；关闭后立即清空收件箱。',
      temporaryVocabTtlLabel: '临时应用词条生命周期（天）',
      temporaryVocabCapacityLabel: '临时词条容量',
      temporaryVocabCapacityDesc: '按最近使用顺序淘汰；固定词条和长期词条永不因容量被删除。',
    },
    codingConsole: {
      title: 'Claude 控制台',

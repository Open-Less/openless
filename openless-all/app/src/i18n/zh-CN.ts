...
export const zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackLabel: '允许 Unicode SendInput 输入',
      allowNonTsfFallbackDesc: 'Windows：默认使用分批 Unicode SendInput；如果失败，再复制到剪贴板。',
    ...
    permissions: {
      ...
      windowsImeDesc: '可选的实验性 TSF 输入法后端。Windows 默认使用 Unicode SendInput，避免进程内文本服务卡死。',
      ...
      windowsIme: {
        installed: '实验性 TSF 后端已注册。',
        notInstalled: '未注册。OpenLess 默认使用 Unicode SendInput。',
        registrationBroken: '实验性 TSF 注册已损坏。',

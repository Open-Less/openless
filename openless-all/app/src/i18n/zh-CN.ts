...
export const zhCN = {
  cloudSyncE2ee: {
    ...
    stepEnableDetail: '打开右侧开关。确认协议之后，下一步是设置同步密码。',
    stepPasswordTitle: '第 2 步，共 3 步：设置同步密码',
    stepPasswordDetail: '还差一步。设好同步密码之后，同步才会开始。现在还没有完成。',
    stepUnlockTitle: '第 2 步，共 3 步：解锁这台设备',
    stepUnlockDetail: '还差一步。输入同步密码，解锁之后才能同步。',
    stepClosedTitle: '同步已关闭',
    stepClosedDetail: '云端备份还在。要继续同步，打开上方的开关。',
    stepDoneTitle: '第 3 步，共 3 步：同步已就绪',
    stepDoneDetail: '这台设备已解锁，同步已经开启。',
    stepPreparingTitle: '正在进入下一步',
    stepPreparingDetail: '协议已经确认。接下来会请你设置同步密码，这一步还没完成。',
    stepFollowDetail: '按这一行旁边的按钮继续。',
    refresh: '刷新状态',
    loading: '正在读取同步状态…',
    signIn: '使用 GitHub 登录',
    signOut: '退出登录',
    ...
    errors: {
      ...
      localData: '这台设备还没准备好本机资料。点「刷新状态」，然后再试一次。',
    },
  },
  cloudSync: {
    title: '云同步',
  ...
  lessComputer: {
    ...
    desktop: {
      ...
      apiCost: '本轮 API 费用',
      emptyHint: '写下具体任务，点麦克风说出来，或用说话快捷键让想法开始行动。',
      showInspector: '显示工作台',
      hideInspector: '收起工作台',
      inspectorTitle: '工作台',
      inspectorStatus: '运行状态',
      inspectorTurn: '本轮',
      toolCalls: '工具调用',
      pendingApprovals: '待确认',
      inspectorVoice: '语音输入',
      voiceShortcutOff: '未设置说话快捷键，可在设置中开启。',
      voiceModesHint: '麦克风：说完先填进输入框，确认后再发送。语音按钮：说完直接交给 Agent。',
      copy: '复制',
      copied: '已复制',
    ...
    voice: {
      dictate: '听写到输入框',
      voiceMode: '语音模式（说完直接发送）',
      stopTask: '停止任务',
      cancel: '取消录音',
      confirmDictation: '完成听写',
      stopAndSend: '停止并发送',
      listening: '正在聆听…',
      starting: '正在准备麦克风…',
      transcribing: '正在转写…',
      empty: '没有听到内容，请再说一次。',
      failed: '语音识别失败，请重试。',
      startFailed: '无法开始录音：{{message}}',
      taskCancelFailed: '任务未能停止，请重试。',
      dictateCaption: '说完点 ✓，文字会填进输入框供你修改 · Esc 取消',
      submitCaption: '说完点 ↑ 直接发送给 Agent · Esc 取消',
      stopHint: '任务运行中，可点击 ■ 停止',
      holdHint: '按住 {{key}} 说话',
      toggleHint: '按 {{key}} 开始或结束说话',
      autoHint: '按住或轻按 {{key}} 说话',
    },
    title: 'Less Computer',
    subtitle: '想让电脑做什么？',
    you: '你',

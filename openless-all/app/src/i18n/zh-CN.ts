...
export const zhCN = {
  ...
  overview: {
    ...
    metricTotalExceeded: '已超过本机存档最大个数',
    metricTotalArchived: '本机已存档{{count}}条',
    weekTitle: '近 7 天',
    weekUnit: '条数 / 天',
    activityTitle: '年度活动',
    ...
    activitySummaryDaily: '{{date}} 使用了 {{count}} 条 / {{chars}} 字 / {{duration}}',
    activitySummaryWeekly: '{{start}} 当周使用了 {{count}} 条 / {{chars}} 字 / {{duration}}',
    activitySummaryCumulative: '截至 {{start}} 当周累计使用了 {{count}} 条 / {{chars}} 字 / {{duration}}',
    activityLegendLow: '少',
  ...
  settings: {
    ...
    recording: {
      ...
      historyRetentionDesc: '超过保留天数的历史在写入新条目时被清理；0 / 留空 = 不按时间清理。',
      historyMaxEntriesLabel: '历史条数上限',
      historyMaxEntriesDesc: '本地保留会话上限，0 / 留空 = 不按条数清理。',
